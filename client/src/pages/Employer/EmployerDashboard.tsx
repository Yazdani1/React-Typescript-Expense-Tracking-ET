...
import { CreateJobPostProps, createJobPosts, JobpostsVisibilityUpdateProps, updateJobPostsVisibility } from '../../services/API';
...
const EmployerDashboard = () => {
  ...
  const [updateJobVisibility, setUpdateJobVisibility] = useState<Visibility>(Visibility.Public);
  ...
  return (
    <EmployerPageLayout>
        ...
        <div className={style.updateVisibilitycontainer}>
          <div className={style.visibility_drop_down_container}>
            <select
              ...
              onChange={(e) => setUpdateJobVisibility(e.target.value as Visibility)}
            >
          ...
          <button className={style.updateVisibilityButton} onClick={handleUpdateJobVisibility}>
      ...
      <div style={{ height: '100vh' }}>
        {jobPosts && jobPosts.map((jobpost) => <EmployerJobPostCard jobpost={jobpost} key={jobpost._id} loadJobposts={loadJobposts} />)}
      </div>
