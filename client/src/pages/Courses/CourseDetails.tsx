...
import {
	getSingleCourseDetailsForSubscriber,
	createCourseEnrolment,
	CreateCourseEnrolmentProps,
} from '../../services/API';
...
const CourseDetails = () => {
	...
	const isCourseEnrolled =
		allEnroledCourses &&
		allEnroledCourses.some(
			(enrollment) => enrollment.courseId?._id === courseDetails?._id
		);
					...
					<CardLayout>
						...
						{isCourseEnrolled ? (
							...
							<button
								...
								onClick={onSubmitCreateCourseEnrolment}
							>
								Enroll
							</button>
						)}
