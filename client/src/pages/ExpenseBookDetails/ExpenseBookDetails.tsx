...
const ExpenseBookDetails = () => {
  ...
  /****************************************/
  // expense book details
  const [expenseBookDetails, setExpenseBookDetails] = useState<any>("");
  ...
  const [expenseBookList, setExpenseBookList] = useState<ExpenseListProps[]>(
    []
  );

  //expense book total amount count based on each category

  const [expenseListTotalAmount, setExpenseBookTotalAmount] = useState<any>([]);
  ...
  const [chooseChartType, setChooseChartType] = useState<string>(
    TotalExpenseChartTypes.Area_Chart
  );
                ...
                <>
                  <div className="choose_chart">
                    <select
                      ...
                      onChange={(e) => setChooseChartType(e.target.value)}
                    >
                      {Object.keys(TotalExpenseChartTypes).map(
                        (chart_type, index) => (
            ...
            >
              <div className="form-group">
                <input
                  type="text"
                  name="Name"
                  className={expenseBookDetailsStyle.expenseBookCategory}
