...
import { updateAnyEmployerJobPosts, UpdateAnyEmployerJobPostProps } from '../../../services/API';
  ...
  return (
    <div className={style.jobpost_container}>
      ...
      >
        ...
        <div className={style.visibility_drop_down_container}>
          <label>Status</label>
          <select value={status} className={style.visiblity_item} onChange={(e) => setStatus(e.target.value as Status)}>
